...
public class OperationActivity extends AppCompatActivity implements Observer {
    ...
    protected void onDestroy() {
        ...
        // 注释掉clearCharacterCallback，防止退出时停止BLE通知
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (currentPage != 0) {
                ...
                // 使用Intent返回到MainActivity，确保MainActivity存在
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (currentPage != 0) {
                    ...
                    // 使用Intent返回到MainActivity，确保MainActivity存在
                    android.content.Intent intent = new android.content.Intent(OperationActivity.this, com.clj.blesample.MainActivity.class);
                    intent.addFlags(android.content.Intent.FLAG_ACTIVITY_CLEAR_TOP | android.content.Intent.FLAG_ACTIVITY_SINGLE_TOP);
                    startActivity(intent);
                    finish();
                }
